...
train_values_X = pd.read_csv('DataHackFI/Capstone_Project/Data/train_values.csv')
train_labels_Y = pd.read_csv('DataHackFI/Capstone_Project/Data/train_labels.csv')
# Success
...
#df_clean["lender"] = np.log1p(df_clean["lender"])
...
print(cols)
print(df_enc.shape)
df_enc.to_csv('DataHackFI/Capstone_Project/Data/df_enc_2.csv')
